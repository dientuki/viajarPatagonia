  ...
  <div class="row">
    <div class="col-sm">
      ...
      <div class="form-check">
        {!! Form::checkbox('is_active', 1, $excursion->is_active, array('class' => 'form-check-input') ) !!}
      ...
      <div class="form-group">
        ...
        {!! Form::text('map', $excursion->map, array('placeholder' => ucfirst(__('fields.map')), 'class'=>$class)) !!}
        @error('map')
        <div class="invalid-feedback">
          <strong>{{ $message }}</strong>
        </div>
