<fieldset class="sticky-wrapper">
    ...
    <div class="row">
        ...
        <?php $packageCurrency = $packagePrice->firstWhere('fk_currency', $currency->id); ?>

        <div class="col-sm">
            <div class="form-group">
                <?php
                  $class = $errors->has('price_' . $currency->id) != null ? 'form-control is-invalid' : 'form-control';
                  $value = isset($packageCurrency->price) ? $packageCurrency->price : null;
                ?>
            ...
            <div class="form-group">
                <?php 
                  ...
                  $value = isset($packageCurrency->discount) ? $packageCurrency->discount : null;
                ?>
            ...
            <div class="form-check">
                <?php $value = isset($packageCurrency->is_active) ? $packageCurrency->is_active : false; ?>
